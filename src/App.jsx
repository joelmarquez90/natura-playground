...
const CAMPAIGNS = [
  ...
  { campana: "Natura UNA", plataforma: "Google Ads", inversion: 540000, impresiones: 980000, clicks: 29400, conversiones: 882, cpa: 612 },
  { campana: "Natura UNA", plataforma: "YouTube", inversion: 310000, impresiones: 1500000, clicks: 22500, conversiones: 450, cpa: 689 },
...
function Module1() {
  ...
  const prompts = [
    "Analizá esta tabla de campañas de Natura. ¿Cuál tiene el mejor CPA? ¿Dónde debería reasignar presupuesto el próximo trimestre?",
...
// ─── Module 2 ─────────────────────────────────────────────────────────────────
function Module2() {
  const brief = `Marca: Natura Cosméticos Argentina
...
KPIs target: ER >3.5%, alcance >150K/post, saves >2%`;
  const prompts = [
    ...
    "Escribime 5 copies para Reels de Natura Ekos que hablen de sustentabilidad sin sonar corporativo. Tono cercano, voseo, que genere saves.",
...
// ─── Module 4 ─────────────────────────────────────────────────────────────────
function Module4() {
  const briefData = `Producto: Natura Tododia — nueva línea de body splash
...
Deadline: 15 abril 2026`;
  const prompts = [
    ...
    "Generame 5 conceptos creativos para esta campaña de Natura Tododia body splash. Cada concepto con nombre, tagline y descripción de la idea visual.",
  ...
  return (
    <div>
      ...
      <div className="rounded-xl p-4 mb-4" style={{ background: "#FFF8F3", border: "1px solid #E8E0D8" }}>
        <div className="flex justify-between items-center mb-2">
          <span className="text-xs font-bold uppercase tracking-wide" style={{ color: "#E85D2C" }}>Brief de campaña — Natura Tododia</span>
...
function Module6() {
  ...
  const prompt = "Tomá este template de business case y personalizalo para Natura Cosméticos Argentina. Hacelo más persuasivo, agregá datos del mercado de belleza y una sección de riesgos y mitigación.";
  return (
    <div>
        ...
        <div className="p-5 pb-3">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs mt-0.5" style={{ color: "#E85D2C" }}>Playground Interactivo · Natura</p>
            </div>
